...
//
// สีมาจากธีมน้ำเงิน-ขาว (design handoff 2026-09-17) ใน css/global.css ซึ่งเขียนเป็น oklch — LINE รับแต่ hex
...
export const THEME = Object.freeze({
    primary: '#006AC5',        // --primary        oklch(0.52 0.17 250)
    primaryDark: '#0058A1',    // --primary-hover  oklch(0.45 0.15 245)
    primaryLight: '#DCF2FF',   // --primary-light  oklch(0.95 0.035 245)
    danger: '#D7352D',         // --danger         oklch(0.58 0.20 28)
    dangerLight: '#FFE4DD',    // --danger-light   oklch(0.95 0.045 30)
    success: '#269E5F',        // --success        oklch(0.62 0.14 155)
    textMain: '#13242E',       // --text-main      oklch(0.25 0.03 235)
    textMuted: '#5A6C79',      // --text-muted     oklch(0.52 0.03 240)
    surface: '#FFFFFF',
    canvas: '#F5FBFF',         // --bg-canvas      oklch(0.985 0.008 240)
    border: '#D9E7F1'          // --border-color   oklch(0.92 0.02 240)
});
