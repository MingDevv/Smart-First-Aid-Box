...
export function validateEvent(value, cabinetId) {
    ...
    if (value.kind === 'sos') {
        ...
        // อาการที่ทำให้ตู้ปฏิเสธการจ่ายยาแล้วเรียกครูแทน (Bank 2026-09-14, หมวดแมลงกัดต่อย)
    ...
    if (![1, 2].includes(value.drawer) || !(identified || value.badgeId === null && value.verifiedBy === 'unidentified' && value.studentId == null) ||
