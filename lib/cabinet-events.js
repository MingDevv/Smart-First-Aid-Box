...
// เคยมี `lineText(event)` ที่ปั้นข้อความ LINE เป็นภาษาอังกฤษอยู่ตรงนี้ — ไม่มีใครเรียกเลย
// ตั้งแต่ lib/line-flex.js เข้ามาแทน · ลบทิ้ง 2026-09-19 พร้อมกับตัวอังกฤษที่ยัง "ใช้งานอยู่จริง"
// ใน lib/web-sos.js · ข้อความถึงครูมีที่มาที่เดียวคือ `lineMessage()`
