...
const WOUND_DATA = {
    ...
    "headache": {
        ...
        "name_en": "Headache",
        "severity": "ทั่วไป (Minor)",
        "image": "../images/symptom_headache.webp",
        "drawer": 3,
        "comingSoon": true,
        "locked": true,
        "description": "ปวดตื้อหรือปวดตุบบริเวณขมับหรือท้ายทอย มักมาจากพักผ่อนไม่พอ อากาศร้อน หรือดื่มน้ำน้อย (อยู่ในระหว่างพัฒนาระบบ)",
        "items": [],
        "itemDetails": [],
        "steps": [],
        "stepDetails": [],
    ...
    "sneeze": {
        "id": "sneeze",
        "name_th": "จาม (แพ้อากาศ)",
        "name_en": "Sneezing & Allergic Rhinitis",
        "severity": "ทั่วไป (Minor)",
        "image": "../images/symptom_sneeze.webp",
        "drawer": 4,
        "comingSoon": true,
        "locked": true,
        "description": "จามติดกันหลายครั้ง คันจมูก น้ำมูกใส มักเกิดจากฝุ่นหรืออากาศเปลี่ยน (อยู่ในระหว่างพัฒนาระบบ)",
        "items": [],
        "itemDetails": [],
        "steps": [],
        "stepDetails": [],
    ...
    "diarrhea": {
        ...
        "image": "../images/symptom_diarrhea.webp",
        "drawer": 5,
        "comingSoon": true,
        "locked": true,
        "description": "ถ่ายเหลวหลายครั้ง ปวดบิดท้อง มักมาจากอาหารหรือน้ำที่ไม่สะอาด (อยู่ในระหว่างพัฒนาระบบ)",
        "items": [],
        "itemDetails": [],
        "steps": [],
        "stepDetails": [],
