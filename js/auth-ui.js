...
//
// ห้ามทำเป็น `<section>` ก้อนเดียวที่ prepend เข้า body — มันกลายเป็นบล็อกแรกของหน้าและ
// **กินพื้นที่เลย์เอาต์จริง** หน้าแรกที่เป็นสามคอลัมน์จะถูกดันจนเสียองค์ประกอบ
//
// โครงสร้างมีสองชิ้น ตามบทบาทที่ต่างกันจริง:
...
(() => {
    ...
    const start = () => {
        ...
        //
        // บนหน้าหลักหลังบ้าน ชิปบัญชีนั่งทับปุ่ม "เติมเวชภัณฑ์" พอดี
        ...
        dialog.innerHTML =
            ...
            // (อย่าชี้ไปหน้าเลือกแผล ซึ่งก็ต้องล็อกอินเหมือนกัน = ทางตันที่ดูเหมือนทางออก)
