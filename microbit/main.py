"""
============================================================
MINIMAL MICRO:BIT V2 FIRMWARE — 2 STEPPER MOTORS ONLY
============================================================
...
def check_buttons():
    ...
    # ปุ่ม P8 : สั่งเปิดช่อง 1 (แผลถลอก)
    ...
    # ปุ่ม P12 : สั่งเปิดช่อง 2 (แมลงกัด)
...
# สั่งหยุดมอเตอร์ก่อนเริ่มต้นใช้งาน
...
def on_forever():
    ...
    # ตรวจสอบการกดปุ่มสั่งมือที่ตัวกล่อง
    check_buttons()
    basic.pause(20)
