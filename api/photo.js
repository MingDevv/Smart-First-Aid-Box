...
//
// Bank 2026-09-14: คนไม่มีบัตรหรือคนนอกที่บาดเจ็บต้องใช้ตู้ได้ แต่ต้องถ่ายรูปหน้าส่งครู
// เหตุผลคือกันคนมากดเล่น · ผมทักเรื่องข้อมูลชีวมาตรของเด็กไปแล้วและ Bank ยืนยัน จึงทำตามนั้น
//
...
// Bank รับทราบและเลือกทางนี้ · สิ่งที่ทำได้คือทำให้เดาไม่ได้และอายุสั้น:
