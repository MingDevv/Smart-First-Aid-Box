...
if (!/^[^@\s]+@tesaban6\.ac\.th$/.test(email || '') || !['student', 'teacher', 'admin'].includes(role)) {
    throw new Error('Usage: emulator-role.mjs synthetic-user@tesaban6.ac.th student|teacher|admin');
}
