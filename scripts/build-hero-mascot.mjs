...
//
// ทำไมต้องมีสคริปต์ ไม่ใช่ลากภาพเข้าโฟลเดอร์เฉยๆ: อาการ "ไม่คม" กับ "ลบพื้นหลังขาวออกไม่หมด"
// ทั้งสองอย่างเป็นผลของ *วิธีแปลง* ไม่ใช่ของต้นฉบับ ถ้าไม่จดวิธีไว้ รอบหน้าก็ได้ผลเดิมอีก
//
// ต้นฉบับ = images/hero_mascot_tagline_source.png
//
// **สองแบบ และสคริปต์แยกให้เอง ไม่ต้องสั่ง**:
//   · ต้นฉบับที่ *มีอัลฟาอยู่แล้ว* (ตัดพื้นมาให้เรียบร้อย เช่น 1672x941 กึ่งโปร่ง 53%
//     ของภาพ) ⇒ **ห้ามแตะอัลฟาเดิม** แค่ครอปตามขอบจริงแล้วเข้ารหัส
//     การเอาขั้นตอนคีย์ขาวไปทับงานที่ตัดมาดีแล้ว มีแต่จะกัดขอบที่เขาไล่มาเรียบร้อยให้เสีย
//   · ต้นฉบับพื้นขาวทึบไม่มีอัลฟา (1920x1080) ⇒ เดินเส้นคีย์ขาวข้างล่าง
//
...
// หน้าผ้าใบขาวของรองเท้า — ผลคือรูโหว่ในรองเท้า และสโลแกนเสียเส้นขอบ
...
// จึงถูก *ขยาย* ทุกเครื่องจริง — เดสก์ท็อป 1.02x มือถือ 1.06x — ซึ่งคืออาการ "ไม่คม"
// · เพดาน 1900 px กันไว้เผื่อวันหนึ่งได้ต้นฉบับใหญ่กว่านี้มา
